      ...
      <MainLayout className="">
        <div className="wrapper my-8 flex w-full items-center justify-center">
          <div className="max-w-7xl">
            <h1 className="m-0 p-0 text-lg font-bold">Your Ride Info</h1>
            <div className="content">
              {!rideInfo ? (
                ...
                <div className="my-4 flex flex-col items-center justify-center">
                  <p>
                    {" "}
                    Car: {rideInfo?.car?.name} {rideInfo?.car?.model}
                  </p>
                  <p>Status: {rideInfo?.ride?.status}</p>
                  <p>
                    Ride Start:
                    {unixToFormat(rideInfo?.ride?.startUnix, "PPP: hh:mm a")}
                  </p>
                  {rideInfo?.ride?.endUnix && (
                    <p>
                      Ride End:
                      {unixToFormat(rideInfo?.ride?.endUnix, "PPP: hh:mm a")}
                    </p>
                  )}
